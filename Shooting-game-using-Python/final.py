...
class Block(object):
    def __init__(self,x,y,width,height):
        ...
        self.width= width
        self.height= height
        self.hitbox = (self.x, self.y ,self.width ,2 )
...
while run:
    ...
    if man.hitbox[1] < blk.hitbox[1] + blk.hitbox[3] and man.hitbox[1] + man.hitbox[3] > blk.hitbox[1]:
        if man.hitbox[0] + man.hitbox[2] > blk.hitbox[0] and man.hitbox[0] < blk.hitbox[0] + blk.hitbox[2]:
            pass
