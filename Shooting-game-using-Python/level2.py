    ...
    class enemy(object):
        ...
        def draw(self,win):
            ...
            if self.visible and g == 1:
                ...
                pygame.draw.rect(win, (0,170,0), (self.hitbox[0], self.hitbox[1] - 20, 50 - (5 * (10 - self.health)), 10))
                self.hitbox = (self.x + 17, self.y + 2, 27, 57)
                #pygame.draw.rect(win, (255,0,0), self.hitbox,2)
        ...
        def hit(self):
            ...
            i=0
            if goblin.visible== False and goblin2.visible== False and goblin3.visible== False:
                while i < 200:
                    pygame.time.delay(10)
                    i += 1
...
man = m.player(600, 405, 64,64)
goblin = m.enemy(300, 410, 64, 64, 800)
goblin2=m.enemy(10, 410, 64, 64, 800)
goblin3=m.enemy(150, 410, 64, 64, 800)
shootLoop = 0
bullets = []
run = True
while run:
